#!/bin/bash
# LeFisher v1.0 is an upgrade from original ShellPhish Tool (https://github.com/thelinuxchoice/shellphish) by thelinuxchoice under GNU LICENSE 
# For Questions Contact Me On:
# Discord - Arthur Valefor#6597, Protonmail - Sir.Arthur56537mr.j@protonmail.com 
...
printf "\n"
printf "     \e[101m\e[1;77m::     Happy Fishing XD, For Questions Email Me Sir.Arthur56537@protonmail.com or Contact me on Discord Arthur Valefor#6597    ::\e[0m\n"
printf "\n"
}
